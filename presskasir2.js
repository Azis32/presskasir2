...
app.AddLayout(lay);
 apb = MUI.CreateAppBar("KasirJos", "menu", "");
 ...
 yx = MUI.CreateTextH2("", 1,0.1);
 pageLay2.AddChild(yx);
 btn1 = MUI.CreateButtonRaisedO("[fa-pencil] TRANSAKSI",0.3);
...
btn3.SetOnTouch(printBiasa);
 ...
 btn5.SetOnTouch(showListNasabah);
 pageLay.AddChild(btn5);
 btn6 = MUI.CreateButtonRaisedO("[fa-tag] BANTUAN",0.3);
btn6.SetOnTouch(bantuan);
 pageLay5.AddChild(btn6);
 btn7 = MUI.CreateButtonRaisedO("[fa-pencil]+PRODUK",0.3);
...
function Start() {
 ...
 apb = MUI.CreateAppBar("Press Kasir", "arrow_back", "search");
