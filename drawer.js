...
function CreateDrawer() {
 ...
 var i = "Data Penjualan::[fa-book],Stok Produk::[fa-book],Tambah Produk::[fa-pencil],Import Produk::[fa-table],Print Teks::[fa-print],Kredit::[fa-book],Header Struk::[fa-home],Footer Struk::[fa-home],";
 ...
 txtTitle.SetTextSize(14, "dip");
 parent2.AddChild(txtTitle);
 i = "Pengaturan::[fa-cogs],Pembuat QR Code::[fa-barcode],Cadangkan Data::[fa-copy],Pulihkan Data::[fa-paste],Perpanjang::[fa-clock-o],Reset Ulang Aplikasi::[fa-history],Lainnya::[fa-tags]";
